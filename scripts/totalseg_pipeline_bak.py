...
def main():
    ...
    parser.add_argument("--include_extra_subtasks_in_combined_label", action="store_true", help="Include --extra_subtasks outputs in TotalSegmentator_nonMuscleMap_labels.nii.gz.")
    ...
    full_label = Path("TotalSegmentator_nonMuscleMap_labels.nii.gz")
    full_csv = Path("TotalSegmentator_nonMuscleMap_labels.csv")
    eroded_label = Path(f"TotalSegmentator_nonMuscleMap_labels_eroded{args.erode_voxels}.nii.gz")
    eroded_stats = Path(f"TotalSegmentator_nonMuscleMap_labels_eroded{args.erode_voxels}_stats.csv")
    ...
    abdominal_muscles_mode = maybe_run_totalsegmentator_subtask(
        ...
        use_fast=(args.abdominal_muscles_fast or args.fast),
        auto_fast_fallback=args.auto_fast_fallback,
    )
